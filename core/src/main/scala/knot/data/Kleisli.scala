...
sealed abstract class KleisliInstances4 extends KleisliInstances5:
  ...
  given commutativeFlatMapForKleisli[F[_]: CommutativeFlatMap, A]: CommutativeFlatMap[Kleisli[F, A, *]] =
  ...
  given composeForKleisli[F[_]: FlatMap, A]: Compose[Kleisli[F, *, *]] =
    new KleisliCompose[F]:
      def F: FlatMap[F] = FlatMap[F]

  given strongForKleisli[F[_]: Functor, A]: Strong[Kleisli[F, *, *]] =
    new KleisliStrong[F]:
...
sealed abstract class KleisliInstances6 extends KleisliInstances7:
  given applicativeErrorForKleisli[F[_], A, E](using ApplicativeError[F, E]): ApplicativeError[Kleisli[F, A, *], E] =
...
sealed abstract class KleisliInstances8 extends KleisliInstances9:
  given applyForKleisli[F[_]: Apply, A]: Apply[Kleisli[F, A, *]] =
...
sealed abstract class KleisliInstances10:
  given functorForKleisli[F[_]: Functor, A]: Functor[Kleisli[F, A, *]] =
